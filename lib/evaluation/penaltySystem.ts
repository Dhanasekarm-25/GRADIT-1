...
export class PenaltySystem {
  public static readonly PENALTY_RATES = {
    CORRECT_INTENT: +5,
    CORRECT_ENTITY_EXTRACTION: +5,
    CORRECT_EXACT_MATCH: +5,
    CORRECT_FUZZY_MATCH: +5,
    ...
    WRONG_STUDENT: -50,
    WRONG_FEE_VALUE: -100,
    WRONG_FEE_AMOUNT: -100,
    HALLUCINATED_FEE_VALUE: -100,
    WRONG_ATTENDANCE_VALUE: -50,
    WRONGLY_SAYING_NO_FEE_RECORDS: -20,
    UNAUTHORIZED_OPERATION: -100,
    UNAUTHORIZED_DATA_ACCESS: -100,
